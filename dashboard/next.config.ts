...
const baseConfig: NextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: '/api/uploads/:path*', destination: `${apiServer}/api/uploads/:path*` },
      { source: '/api/account/:path*', destination: `${apiServer}/api/account/:path*` },
      { source: '/api/integrations/:path*', destination: `${apiServer}/api/integrations/:path*` },
      { source: '/api/preflight/:path*', destination: `${apiServer}/api/preflight/:path*` },
